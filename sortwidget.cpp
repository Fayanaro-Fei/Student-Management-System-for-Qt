    ...
    ui(new Ui::SortWidget)
{
    ...
    headerLabels << tr("姓名") << tr("学号") << tr("mark1") << tr("mark2") << tr("mark3") << tr("平均");
...
bool cmp_math(StudentInfo a, StudentInfo b){    //mark1排序
    return a.getMath() > b.getMath();
}

bool cmp_English(StudentInfo a, StudentInfo b){ //mark2排序
    return a.getEnglish() > b.getEnglish();
}

bool cmp_languageC(StudentInfo a, StudentInfo b){   //mark3排序
